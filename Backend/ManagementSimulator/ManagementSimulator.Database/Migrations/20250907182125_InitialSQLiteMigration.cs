        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BudgetedFTEs = table.Column<float>(type: "REAL", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Vacation = table.Column<int>(type: "INTEGER", nullable: false),
                    EmploymentType = table.Column<int>(type: "INTEGER", nullable: false),
                    TotalAvailability = table.Column<float>(type: "REAL", nullable: false),
                    RemainingAvailability = table.Column<float>(type: "REAL", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "TEXT", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_EmployeeRolesUsers", x => new { x.RolesId, x.UsersId });
                    table.ForeignKey(
                        name: "FK_EmployeeRolesUsers_EmployeeRoles_RolesId",
                        column: x => x.RolesId,
                        principalTable: "EmployeeRoles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_EmployeeRolesUsers_Users_UsersId",
                        column: x => x.UsersId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LeaveRequestTypeId = table.Column<int>(type: "INTEGER", nullable: false),
                    StartDate = table.Column<DateTime>(type: "TEXT", nullable: false),
                    EndDate = table.Column<DateTime>(type: "TEXT", nullable: false),
                    Reason = table.Column<string>(type: "TEXT", nullable: true),
                    RequestStatus = table.Column<int>(type: "INTEGER", nullable: false),
                    ReviewerComment = table.Column<string>(type: "TEXT", maxLength: 100, nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "TEXT", nullable: false),
                    ModifiedAt = table.Column<DateTime>(type: "TEXT", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "TEXT", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_LeaveRequests_LeaveRequestTypes_LeaveRequestTypeId",
                        column: x => x.LeaveRequestTypeId,
                        principalTable: "LeaveRequestTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LeaveRequests_Users_ReviewerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    SecondManagerEmployeeId = table.Column<int>(type: "INTEGER", nullable: false),
                    ReplacedManagerId = table.Column<int>(type: "INTEGER", nullable: false),
                    StartDate = table.Column<DateTime>(type: "TEXT", nullable: false),
                    EndDate = table.Column<DateTime>(type: "TEXT", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TimePercentagePerProject = table.Column<float>(type: "REAL", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_EmployeeRolesUsers_UsersId",
                table: "EmployeeRolesUsers",
                column: "UsersId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeaveRequests_LeaveRequestTypeId",
                table: "LeaveRequests",
                column: "LeaveRequestTypeId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeaveRequestTypes_IsPaid_Title",
                table: "LeaveRequestTypes",
                columns: new[] { "IsPaid", "Title" },
                unique: true);
