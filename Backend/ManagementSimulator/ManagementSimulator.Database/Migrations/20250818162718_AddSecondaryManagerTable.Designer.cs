...
namespace ManagementSimulator.Database.Migrations
{
    ...
    [Migration("20250818162718_AddSecondaryManagerTable")]
    partial class AddSecondaryManagerTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ManagementSimulator.Database.Entities.SecondaryManager", b =>
                {
                    b.Property<int>("EmployeeId")
                        .HasColumnType("int");
                    ...
                    b.HasKey("EmployeeId", "SecondaryManagerId", "StartDate");

                    b.HasIndex("AssignedByAdminId");

                    b.HasIndex("SecondaryManagerId");

                    b.ToTable("SecondaryManagers");
                });
            ...
            modelBuilder.Entity("ManagementSimulator.Database.Entities.SecondaryManager", b =>
                {
                    b.HasOne("ManagementSimulator.Database.Entities.User", "AssignedByAdmin")
                        .WithMany()
