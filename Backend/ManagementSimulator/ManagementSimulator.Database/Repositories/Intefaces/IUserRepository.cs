...
namespace ManagementSimulator.Database.Repositories.Intefaces
{
    ...
    {
        Task<(List<User>? Data, int TotalCount)> GetAllUnassignedUsersFilteredAsync(QueryParams parameters, bool includeDeleted = false, bool tracking = false);
        Task<List<User>> GetAllAdminsAsync(string? lastName, string? email, bool includeDeleted = false, bool tracking = false);
        ...
        Task<(List<User>? Data, int TotalCount)> GetAllUsersWithReferencesFilteredAsync(string? lastName, string? email, string? department, string? jobTitle, string? globalSearch, QueryParams parameters, bool includeDeleted = false, bool tracking = false); 
        ...
        Task<List<User>> GetUsersByManagerIdAsync(int managerId, bool includeDeleted = false, bool tracking = false);
        ...
        Task<(List<User> Data, int TotalCount)> GetAllManagersFilteredAsync(string? lastName, string? email, QueryParams parameters, bool includeDeleted = false, bool tracking = false);
    }
}
